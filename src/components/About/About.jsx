...
export const About = () => {
    return(
       <div className="bg-Tp m-0 py-[100px] gap-5 items-center p-5 flex flex-col md:flex-row justify-center rounded">
        <div>
            <img src={AboutImg} alt="" />
        </div>
        <div className="max-w-[800px] flex flex-col gap-2">
            <h1 className="uppercase font-myfont text-slate-50 text-[30px]  ">About Us</h1>
            <p className="font-fonty  text-slate-300 text-[15px]  ">Welcome to <strong className="font-bold text-slate-50">HomeDecor</strong> , your one-stop shop for stylish furniture and home decor. We offer a carefully curated selection of high-quality products that will transform your house into a beautiful and inviting home.
...
<Link className="bg-slate-50 p-2 my-[20px] w-fit rounded shadow-2xl font-semibold capitalize text-[20px] ">Continue shopping</Link>
        </div>
       </div>
    )
}