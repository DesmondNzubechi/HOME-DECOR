...
export const Footer = () => {
    return (
       ...
       <h1 className="text-slate-100 font-myfont text-[25px]">Homedecor</h1>
         <p className="text-slate-200 text-[17px] pt-[20px] max-w-[400px]">Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat.
               ...
               <a href="https://nzubechukwu.com" className="text-[20px] shadow-xl p-1 bg-white text-slate-900 rounded-full"><FiExternalLink /></a>
                ...
                <div className="flex flex-col gap-2">
       <h1 className="text-slate-100 font-bold text-[25px]">In<span className="">fomation</span></h1>
         ...
         <p><a href="mailto:nzubestdesmond@gmail.com" className="flex flex-row items-center gap-3 my-2"><span className="bg-white p-2 rounded-full font-bold"><AiOutlineMail className="text-[25px]  "/></span> <span className="text-slate-300 text-[15px] ">Info@Homedecor.com</span></a></p>
       </div>
<div className="flex flex-col gap-2">
...
<div className="flex flex-col gap-2">
    ...
    <p className="text-slate-200 text-[17px] pt-[20px] max-w-[400px]">Get notified of all our premium discounts and promos. We will also notify
    ...
    <button type="submit" className="bg-slate-900 text-white px-1 rounded shadow-xl  md:text-[20px]">Subscribe</button>
       ...
       <hr />
          ...
          <div className="flex md:flex-row flex-col gap-3 items-center justify-around mt-[20px]">
            <p className="flex flex-row items-center gap-1 text-slate-400 text-[12] md:text-[18px]">Website built out of <span className="text-red-500 text-[20px] md:text-[30px]"><AiTwotoneHeart /></span> by <a className="uppercase font-bold text-white italic" href="https://nzubechukwu.com">Nzubechukwu</a> </p>
            <p className="md:text-[20px] text-[15px] text-slate-400">&copy; Homedecor 2023</p>
          </div>
        </footer>
    )
}