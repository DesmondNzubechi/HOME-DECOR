...
<div>
    <div className="flex-col flex gap-5" >
        ...
        <div className="flex gap-1 flex-col">
            <span className="w-full border border-slate-500 h-[10px] flex "><span className=" w-[66%] bg-slate-900 h-[10px] "></span></span>
        ...
        <div className="grid md:grid-cols-2 grid-cols-1 gap-5 ">
            <div className="flex flex-col gap-0  border border-slate-500 p-2 rounded">
