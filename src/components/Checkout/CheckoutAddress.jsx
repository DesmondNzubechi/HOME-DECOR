...
<div>
    <div className="flex-col flex gap-5" >
        ...
        <div className="flex gap-1 flex-col">
            <span className="w-full border h-[10px] flex "><span className=" w-[66%] bg-slate-900 h-[10px] "></span></span>
        ...
        <div className="flex flex-col gap-1">
            <h2 className="text-[20px] font-fonty capitalize  ">Shipping address info.</h2>
