...
fullDetail.map(items => {
    return (
        <div className={`fixed px-[40px] flex flex-row justify-center bg-Tp   left-0 right-0 w-full h-full  top-0 z-[50] `}>
        <div className="bg-slate-100 relative p-4 overflow-y-auto  max-w-[400px] ">
...
<div className="">
  <img src={items.Img} alt=""  className="w-full h-full"/>
    ...
    <button className="bg-slate-800  px-[10px] py-[5px]  rounded text-[14px] md:text-[17px] text-slate-50 border ">Add to Cart</button>
    <button className=" border border-slate-800 rounded text-slate-800 text-[14px] md:text-[17px]">Add to Wishlist</button>
</div>
</div>
        <div>
            ...
            <div>
                ...
                <p className="text-slate-600 text-[13px]  font-fonty" >{items.descr}</p>
            </div>
